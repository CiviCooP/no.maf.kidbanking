...
class CRM_Banking_PluginImpl_Matcher_ChangeNotificationFromBank extends CRM_Banking_PluginImpl_Matcher_KID {
  ...
  public function match(CRM_Banking_BAO_BankTransaction $btx, CRM_Banking_Matcher_Context $context) {
    ...
    foreach($mandates['values'] as $mandate) {
      ...
      $suggestion->setTitle(ts("Change whether the donor wants to be notified"));
  ...
  function visualize_match( CRM_Banking_Matcher_Suggestion $suggestion, $btx) {
    ...
    $html_snippet = $smarty->fetch('CRM/Banking/PluginImpl/Matcher/ChangeNotificationFromBank.suggestion.tpl');
    $smarty->popScope();
    return $html_snippet;
  }
  ...
  function visualize_execution_info( CRM_Banking_Matcher_Suggestion $match, $btx) {
    ...
    $smarty = CRM_Banking_Helpers_Smarty::singleton();
    $smarty->pushScope($smarty_vars);
    $html_snippet = $smarty->fetch('CRM/Banking/PluginImpl/Matcher/ChangeNotificationFromBank.execution.tpl');
    $smarty->popScope();
    return $html_snippet;
  }
}
